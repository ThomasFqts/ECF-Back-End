...
if ($_SERVER['REQUEST_METHOD'] === "POST") {
    ...
    an_surf_tot = ?, an_prix = ?, an_d_modif = ?, an_etat = ?, d_id = ?, tp_ofr_id = ?, tp_bn_id = ? 
    WHERE an_id = ?;");
    $stmt->execute([$nbre_piece, $ref, $titre_annonce, $desc, $loc, $surf_hab, $surf_tot, $prix, $date_modif, $etat, $diagnostic, $type_offre, $type_bien, $an_id]);
